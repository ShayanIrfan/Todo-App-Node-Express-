...
function run() {
    ...
    const create_fn = (data) => {
        ...
        editBtn.setAttribute("onclick", "obj.editTodo(this)");
        editBtn.setAttribute("onmouseover", "obj.glow(this, '#0062FF', 0)");
        editBtn.setAttribute("onmouseout", "obj.dull(this, 0)");
        ...
        delBtn.setAttribute("onclick", "obj.deleteTodo(this)");
        delBtn.setAttribute("onmouseover", "obj.glow(this, '#FF0000', 0)");
        delBtn.setAttribute("onmouseout", "obj.dull(this, 0)");
